...
const c = {
  ...
  details: {
    ...
    filedStatement: 'yes',
    positionId: 'Z2lkOi8vYmFsbG90LWZhY3RvcnkvUG9zaXRpb24vMjc0ODcy',
    electionId: 'Z2lkOi8vYmFsbG90LWZhY3RvcnkvRWxlY3Rpb24vNDI3Ng==',
    otherOffice: 'Washington County Commission - District 1',
  },
  goals: {
    filedStatement: 'yes',
    campaignCommittee: 'committee of JavaScript',
  ...
  campaignPlanStatus: {
    ...
    policyPlatform: { status: 'completed', createdAt: 1704252053982 },
  ...
  campaignPlan: {
    ...
    policyPlatform:
      '<div class="container mx-auto p-8">\n  <h2 class="text-3xl font-bold mb-4">Tomer Almog\'s Policy Platform</h2>\n  \n  <!-- Policy 1: Improving Education -->\n  <div class="mb-8">\n    <h3 class="text-xl font-bold mb-2">Improving Education</h3>\n    <ul class="list-disc list-inside">\n      <li class="mb-1">Cancel private schools to prioritize public education</li>\n      <li class="mb-1">Allocate funding towards public schools for better resources and facilities</li>\n      <li class="mb-1">Establish partnerships with local businesses and organizations to enhance educational opportunities</li>\n    </ul>\n  </div>\n  \n  <!-- Policy 2: Promoting Technology and Innovation -->\n  <div class="mb-8">\n    <h3 class="text-xl font-bold mb-2">Promoting Technology and Innovation</h3>\n    <ul class="list-disc list-inside">\n      <li class="mb-1">Invest in technology infrastructure to bridge the digital divide</li>\n      <li class="mb-1">Support local start-ups and entrepreneurs through grants and mentorship programs</li>\n      <li class="mb-1">Advocate for policies that promote research and development in emerging technologies</li>\n    </ul>\n  </div>\n  \n  <!-- Policy 3: Sustaining the Environment -->\n  <div class="mb-8">\n    <h3 class="text-xl font-bold mb-2">Sustaining the Environment</h3>\n    <ul class="list-disc list-inside">\n      <li class="mb-1">Implement eco-friendly initiatives to reduce carbon footprint</li>\n      <li class="mb-1">Encourage renewable energy adoption and invest in sustainable infrastructure</li>\n      <li class="mb-1">Work with local conservation groups to protect natural resources and wildlife habitats</li>\n    </ul>\n  </div>\n</div>',
    getOutTheVote:
  ...
  reportedVoterGoals: { doorKnocking: 40799, calls: 12490, digital: 1400 },
  lastVisited: 1704252042063,
  id: 1,
  customIssues: [
    {
      title: 'Education',
