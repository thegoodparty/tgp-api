...
const qaCampaign = {
  ...
  goals: {
    ...
    runningAgainst: [
      ...
      { name: 'Another', description: 'whatever', party: 'Democrat Party' },
    ],
    campaignWebsite: 'https://tomeralmog.com',
  },
  campaignPlanStatus: {
    timeline: { status: 'completed', createdAt: 2678400000 },
    policyPlatform: { status: 'completed', createdAt: 1704252398506 },
    ...
    launchEmail2: { status: 'completed', createdAt: 1709836678212 },
  },
  campaignPlan: {
    ...
    policyPlatform:
      '<div class="container mx-auto p-4 bg-white">\n  <h2 class="text-3xl font-bold mb-4">Tomer Almog\'s Policy Platform</h2>\n  \n  <div class="mb-6">\n    <h3 class="text-xl font-bold">1. Fund Public Schools - Education</h3>\n    <ul class="list-disc list-inside">\n      <li>Increased Funding: Advocate for higher budgets to ensure adequate resources, technology, and infrastructure in public schools.</li>\n      <li>Teacher Support: Implement initiatives to attract and retain highly qualified educators through competitive salaries, professional development opportunities, and mentoring programs.</li>\n      <li>Equitable Distribution: Work towards an equitable distribution of funds, prioritizing schools in underserved communities to bridge the achievement gap.</li>\n    </ul>\n  </div>\n  \n  <div class="mb-6">\n    <h3 class="text-xl font-bold">2. Stop Book Bans - Education</h3>\n    <ul class="list-disc list-inside">\n      <li>Protect Academic Freedom: Oppose any attempts to ban books or limit access to diverse educational materials, ensuring students have the opportunity to explore different perspectives.</li>\n      <li>Promote Critical Thinking: Encourage open dialogue in classrooms to foster critical thinking skills and the ability to analyze complex issues from various viewpoints.</li>\n      <li>Provide Resources: Advocate for comprehensive curriculum resources that engage students in diverse literature and encourage a deeper understanding of social issues.</li>\n    </ul>\n  </div>\n  \n  <div>\n    <h3 class="text-xl font-bold">3. Education - Cancel Private Schools</h3>\n    <ul class="list-disc list-inside">\n      <li>Promote Equality: Support the elimination of private schools to create a more equal education system where every child has access to high-quality education.</li>\n      <li>Invest in Public Schools: Redirect resources and funding towards improving public schools to ensure they can meet the needs of all students, regardless of socioeconomic status.</li>\n      <li.Enhance Inclusivity: Encourage diversity and representation within public schools by attracting students from various backgrounds, fostering a more inclusive learning environment.</li>\n    </ul>\n  </div>\n</div>',
    getOutTheVote:
  ...
  pathToVictory: {
    totalRegisteredVoters: 9984,
    republicans: 2614,
    democrats: 4531,
    indies: 2839,
    averageTurnout: 6087,
    projectedTurnout: 6091,
    winNumber: '3047.00',
    voterContactGoal: '15235.00',
  ...
  aiContent: {
    ...
    launchEmail2: {
      name: 'Launch Email2',
      updatedAt: 1709836714361,
      inputValues: {},
      content:
        '\n<div class="text-black">\n    <h1 class="text-xl font-bold mb-4">🎉 Announcing Tomer Almog for Washington County Commission - District 1 🎉</h1>\n    <p class="mb-4">Dear Friends and Supporters,</p>\n    <p class="mb-4">Today marks a significant moment for our community in Washington County as I, Tomer Almog, officially announce my candidacy for the County Commission, District 1, under the banner of the Forward Party. As the CTO of Good Party and a passionate musician, I\'ve dedicated my life to fostering creativity, pursuing excellence, and building stronger communities.</p>\n    <p class="mb-4">My journey has been one of dedication and hard work, from the strings of my guitar to the halls of our local school board, where I served for five years. There, I fought for the heart of our future—our children—ensuring they receive a quality education. We celebrated achievements: higher student outcomes, increased graduation rates, and enhanced school facilities. These accomplishments were not just wins for our schools but for our entire community.</p>\n    <p class="mb-4">But our work is far from over. Our campaign is built on the belief that <strong>education is the cornerstone of a thriving society</strong>. We must champion policies that fund public schools adequately, stand against the censorship of knowledge, and embrace an educational system that serves all, not just the privileged few. It\'s time to put an end to private schooling as a status symbol and ensure that every child, regardless of their background, has access to the highest standards of education.</p>\n    <p class="mb-4">This campaign is about more than just one person; it\'s about all of us coming together to create a future that reflects our shared values and aspirations. A future where education opens doors, where our community\'s voice is heard, and where we all have the opportunity to succeed.</p>\n    <p class="mb-4">I\'m stepping up to serve because I believe in our ability to make a difference. But I cannot do it alone. This is a call to action for each of you to join me in this journey. Whether you can volunteer, contribute financially, or simply spread the word, your support is invaluable.</p>\n    <p class="mb-4">Together, we can chart a new course for Washington County. Together, we can ensure that our community\'s future is as bright as the minds we are committed to nurturing. Let\'s make history together.</p>\n    <p class="mb-4">With heartfelt thanks and unyielding optimism,</p>\n    <p class="font-bold">Tomer Almog</p>\n    <p class="italic">Candidate for Washington County Commission - District 1</p>\n    <p class="mt-4">P.S. Stay tuned for more updates on our campaign. Together, let\'s move forward!</p>\n</div>\n',
    },
  },
  lastStepDate: '2024-04-10',
  reportedVoterGoals: { doorKnocking: 40799, calls: 13890, digital: 1400 },
  lastVisited: 1713548500346,
  id: 1,
  customIssues: [
    {
      title: 'Education',
